class View {
  ...
  public void display () {
    ...
    line (width/2, height/2 - maxDistance - radius/2, width/2 + maxDistance, height/2 - maxDistance - radius/2);
    line (width/2, height/2 - maxDistance - radius/2 + 4, width/2, height/2 - maxDistance - radius/2 - 4);
    line (width/2 + maxDistance, height/2 - maxDistance - radius/2 + 4, width/2 + maxDistance, height/2 - maxDistance - radius/2 - 4);
    textAlign (CENTER, CENTER);
    textSize (8);
    fill (200, 200, 20, 200);
    text (maxDistance, width/2 + maxDistance / 2, height/2 - maxDistance - radius - 8);
